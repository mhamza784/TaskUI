            ...
            <div className=" flex flex-col static ">
              ...
              <Tabs defaultActiveKey="1" onChange={onChange}>
                <TabPane tab={
                  ...
                  <>
                    <div className='bg-white rounded sm:h-[390px] h-[200px] sm:w-[1246px] w-[98%] sm:mb-[40px] mb-[30px]'>
                ...
                <TabPane tab={
                  ...
                  key="2">
                  <>
                    <div className=' bg-white rounded sm:h-[390px] h-[390px] sm:w-[1246px] w-[98%] sm:mb-[40px] mb-[30px]'>
                      <div className='sm:ml-20 ml-3 font-sans not-italic'>
                        <p className='sm:ml-20 ml-3 sm:text-4xl text-2xl  font-extrabold  '>Installation Steps:</p>
                        <p className='text-bold text-lg   '>Installation Steps:</p>
                        ...
                        <p className='text-bold text-lg'>Command:</p>
